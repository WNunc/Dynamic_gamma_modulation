...
% function.
% eegTS is the time stamp for the EEG recordings)(NOT interpolated) (CSC file), 
% one time stamp for every 512 points.  This variable is part of the output of the
% 'load_eeg' function.
