...
subfolder = 'Tseq-CCW\';
case1 = '-ontrack_exfg'; %exclude fgamma
ncells = 3;nspkikes = 5;
...
for L = 1:2
    for ns = 1:isession
        ...
        theta_info = {};
        nseg = 1;
        m_vel = zeros(1,5); sem_vel = zeros(1,5);% 平均速度; 速度标准误
        txtid = fopen([path_ns,subfolder,'thetacycle4calculating',case1,'.txt'],'w');
        for nl = 1:5
            file_input1 = strcat(path_ns,subfolder,...
                'scores',num2str(nseg),'-',num2str(nl),case1,'_TSlap_vel0',lockat{L},'.mat');
...
%             end
            ...
            file_input2 = strcat(path_ns,'CuttingPhaseCCW\data_AllLap_thetaphasecut_',case3,'.mat');
            load(file_input2)
            
            file_input3 = strcat(path_ns,subfolder,'Cells_allsegment_v1_vel_0.mat');
            S1 = load(file_input3);
            
            file_input4 = strcat(path_ns,subfolder,'Cells_allsegment_v1_vel_5.mat');
            S2 = load(file_input4);
            
            file_input5 = strcat(path_ns,subfolder,'Data_angle_ontrack.mat');
            load(file_input5,'data_angle');
            
            file_input6 = strcat(path_ns,subfolder,...
                'data_theta_seq_info-ontrack_lap',num2str(nl),case2,case3,midmod,'_v5.mat');
            load(file_input6)
            fprintf(1,'input file:\n%s\n%s\n%s\n%s\n',file_input1,file_input2,file_input3,file_input5)
            fprintf(1,'theta windows file:\n%s\n',file_input6)
            fprintf(txtid,'input file:\n%s\n%s\n%s\n%s\n%s\ntheta windows file:\n%s\n',...
                file_input1,file_input2,file_input3,file_input4,file_input5,file_input6);
            lap_ts = scores{nl,6};
            ...
            saveas(figure(1),[path_ns subfolder 'decoding_single_lap',num2str(nl),case1,'_',lockat{L},'.png'])
            %%
            ...
            spikes = spikes(cind_ot_exfg,:);
            cell_ontrack = length(cind_ot_exfg)
        ...
        title(['lap-' num2str(nl) ', ThSeq_N_u_m = ' num2str(iii)],'FontSize',14)
            ...
            %%
            save([path_ns,subfolder,'data_theta_seq_info',case1,'_lap',num2str(nl),case2,case3,midmod,lockat{L},'.mat'],...
                'thetaind','ind_ok',...
        ...
        saveas(figure(2),[path_ns,subfolder,'thetaseq_strcture',case1,'1',case2,case3,midmod,lockat{L},'.png'])
        saveas(figure(3),[path_ns,subfolder,'thetaseq_strcture',case1,'2',case2,case3,midmod,lockat{L},'.png'])
        saveas(figure(4),[path_ns,subfolder,'thetaseq_pxn',case1,'1',case2,case3,midmod,lockat{L},'.png'])
        saveas(figure(5),[path_ns,subfolder,'thetaseq_pxn',case1,'2',case2,case3,midmod,lockat{L},'.png'])
        fclose(txtid);
        save([path_ns,subfolder,'data_theta_seq_info','_AllLap',case1,case2,case3,midmod,lockat{L},'.mat'],...
