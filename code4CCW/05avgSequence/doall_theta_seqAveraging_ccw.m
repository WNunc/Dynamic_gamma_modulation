...
Num_cellot = nan(1,5); % number of cell on track
for ns = 1:isession
    path_ns = path{ns};
    ...
    m_vel = zeros(1,5); % 平均速度
    sem_vel = zeros(1,5); % 速度标准误
    alignpxn = {}; % 对齐后的pxn
    for nl = 1:5
        ...
        saveas(figure(1),[path_ns subfolder 'decoding_single_lap',num2str(nl),midmod,'.png'])
        %%
        ...
        spikes = S1.spikes; % use S1 ratemap
        spk = [];sp = [];
        ac = [];
        ...
        %%
        save([path_ns,subfolder,'data_theta_seq_info',case1,'_lap',num2str(nl),case2,case3,midmod,'_v5.mat'],...
            'thetaind','ind_ok',...
    ...
    set(gca,'FontSize',16)
    legend([{'in cycle'},{'loc 1-18'}],'FontSize',14)
    
    saveas(figure(2),[path_ns,subfolder,'thetaseq_strcture',case1,'1',case2,case3,midmod,'.png'])
    saveas(figure(3),[path_ns,subfolder,'thetaseq_strcture',case1,'2',case2,case3,midmod,'.png'])
    
    saveas(figure(4),[path_ns,subfolder,'thetaseq_pxn',case1,'1',case2,case3,midmod,'.png'])
    saveas(figure(5),[path_ns,subfolder,'thetaseq_pxn',case1,'2',case2,case3,midmod,'.png'])
    
    saveas(ff,[path_ns,subfolder,'speed_over_lap',case1,case2,case3,midmod,'.png'])
    save([path_ns,subfolder,'data_theta_seq_info','_AllLap',case1,case2,case3,midmod,'_v5.mat'],...
