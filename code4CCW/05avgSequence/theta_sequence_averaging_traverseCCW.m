...
for ns = 16:25
    ...
    while traverseIND < 36
        ...
        mkdir(['CuttingPhaseCCW\phase_' case3])
        close all
        theta_info = {};
        nseg = 1;
        m_vel = zeros(1,5);
        ...
        for nl = 1:5
            ...
            saveas(figure(1),[path_ns, 'CuttingPhaseCCW\phase_', case3, '\decoding_single_lap',num2str(nl),midmod,'.png'])
            close(figure(1))
            figure(2); %对齐位置
            ...
            %%
            save([path_ns,'CuttingPhaseCCW\phase_', case3, '\data_theta_seq_info',case1,'_lap',num2str(nl),case2,case3,midmod,'_v5.mat'],...
                'thetaind','ind_ok',...
        ...
        saveas(figure(2),[path_ns,'CuttingPhaseCCW\phase_', case3,'\thetaseq_strcture',case1,'1',case2,case3,midmod,'.png'])
        saveas(figure(3),[path_ns,'CuttingPhaseCCW\phase_', case3,'\thetaseq_strcture',case1,'2',case2,case3,midmod,'.png'])
        %     saveas(figure(3),[path_ns,subfolder,'thseq-lap-',subfix,'3-x.png'])
        %     saveas(figure(6),[path_ns,subfolder,'thseq-lap-pxn',subfix,'3-x.png'])
        save([path_ns,'CuttingPhaseCCW\phase_', case3,'\data_theta_seq_info','_AllLap',case1,case2,case3,midmod,'_v5.mat'],...
    ...
    save('CuttingPhaseCCW\value_stat.mat','ProbDiff_stat','WeightCorr_stat','FlipCorr_stat',...
