...
for ns = 1:isession
    ...
    saveas(figure(1),[path_ns,'CuttingPhaseCCW\thetaseq_strcture_all',case1,'1',case2,case3,midmod,'.png'])
    saveas(figure(2),[path_ns,'CuttingPhaseCCW\thetaseq_strcture_all',case1,'2',case2,case3,midmod,'.png'])
    close all
    save('CuttingPhaseCCW\value_stat.mat','ProbDiff_stat','WeightCorr_stat','FlipCorr_stat',...
        'goodphase1','goodphase2','goodphase3')
end
save('CuttingPhaseCCW\phase_hist.mat','ProbDiff_stat','WeightCorr_stat','FlipCorr_stat',...
    'goodphase1all','goodphase2all','goodphase3all')
