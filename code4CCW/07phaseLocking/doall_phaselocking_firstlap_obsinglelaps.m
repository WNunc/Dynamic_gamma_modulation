...
% file_input3 = [subfolder 'data_phaselocking_spkmin.mat'];  % phase locking feature running TS
file_input3 = [subfolder 'data_phaselocking_TSlap.mat'];  % ** phase locking feature trial TS
...
%     for fgcell = 1:icell
%         ff = figure(1);
%         set(ff, 'Position',[0 650 350*cellnum_fg(nsn) 350])
...
%     else
%         vecLength_slap(nsn,:) = allcellvL_fg;% singlelap
%         vecLength_flap(nsn,1) = vecLength_slap(nsn,1);% first lap to other
%         vecLength_flap(nsn,2) = mean(vecLength_slap(nsn,2:5));% first lap to other
%     end
%     
