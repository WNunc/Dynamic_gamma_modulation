...
for ns = 3
    ...
    for nt = 1:1 % trial number
        ...
        for nl = 1:laps
            ...
            file_input = strcat(path{ns},'Tseq-CCW\scores',num2str(nt)','-',num2str(nl),subfix,'_v5.mat');
        ...
        for nl = 1:laps
            ...
            file_output = strcat(path{ns},'Tseq-CCW\scores',num2str(nt)','-',num2str(nl),subfix,'_v5.mat');
            load (file_output)
