    ...
    for D = 1:2 %1 =CW, 2 = CCW
        ...
        while traverseIND < 36
            ...
            for nl = 1:5
                ...
                saveas(figure(1),[path_ns, subfolder2, 'phase_', case3, '\decoding_single_lap',num2str(nl),midmod,'v0.png'])
                clf
                %%
                ...
                %%
                save([path_ns,subfolder2,'phase_', case3, '\data_theta_seq_info',case1,'_lap',num2str(nl),case2,case3,midmod,'_v5.mat'],...
                    'thetaind','ind_ok',...
                    'mid_cycle','mid_sequence','midcy_pxn','midsq_pxn',...
                    'diff_comreal',...
                    'TSS','TSS_mean1','TSS_mean2','iii')
                [ProbDiff(1,nl) ,~] = probdiff(TSS_mean1,TPsweep,SPsweep);
                [WeigCorr(1,nl),~] = nanweightcorr(TSS_mean1,TPsweep,SPsweep);
            ...
            saveas(figure(2),[path_ns,subfolder2,'phase_', case3,'\thetaseq_strcture',case1,'1',case2,case3,midmod,'.png'])
            saveas(figure(3),[path_ns,subfolder2,'phase_', case3,'\thetaseq_strcture',case1,'2',case2,case3,midmod,'.png'])
            save([path_ns,subfolder2,'phase_', case3,'\data_theta_seq_info','_AllLap',case1,case2,case3,midmod,'_v5.mat'],...
...
%         goodphase3 = (goodphase3-1)*phasestep;
        save([subfolder2,'value_stat.mat'],'ProbDiff_stat','WeightCorr_stat','FlipCorr_stat')
        clear ProbDiff_stat WeightCorr_stat FlipCorr_stat
    end
end
