...
for L = 2 % 1:2
    ...
    for ns = 1:isession
        ...
        for S = 1:3
            ...
            for    nl = 1:5
                file_input1 = [inFolder,'data_theta_seq_info',subfix,'_lap',num2str(nl),ncases,case3,midmod,'_v5-both-',num2str(S), '_v2.mat'];
                ...
                file_input2 = [inFolder,'data_theta_seq_info',subfix2,'_lap',num2str(nl),ncases,case3,midmod,lockat{L},'_v5-both-',num2str(S), '_v2.mat'];
                file_input3 = [inFolder,'data_theta_seq_info',subfix4,'_lap',num2str(nl),ncases,case3,midmod,lockat{L},'_v5-both-',num2str(S), '_v2.mat'];
...
%         save([outFolder 'weight_corr_eachseq_part.mat'],'wc1','wc2');
    ...
    for S = 1:2
        for nl = 1:5
            if S == 1
            wc1_all{S,nl} = [wc1_all{S,nl};wc1_all{3,nl}];
            wc2_all{S,nl} = [wc2_all{S,nl};wc2_all{3,nl}];
            end
