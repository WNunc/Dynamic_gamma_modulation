...
for ns = [1,2,4:6,8,10:13,15,16]%1:isession%[1:4,6,7]%[1;2;4;5;6;8;10;11;16;20;22;25]'%[1:11,16,20:22,26,27]%[1;2;5;6;8;10;11;13;20;22;23;24;27;28]'%
    ...
    for D = 1:2
        ...
        load(file_input4)
        load(file_input5)
        file_input6 = [subfolder1,'scores1-1-ontrack_dsfg_TSlap_vel0',lockat{L},'v3.mat'];
        ...
        for nt = 1% this file for pre_running only
            ...
            %%%%%%%%%%%%打开注释，获得全部非FG相锁的cell%%%%%%%%%%%
            cind_ot_nonfg = ~ismember(cind_ot,cind_ot_fg);
        ...
        for ifgcell = 1:icell
            ...
            PreferPhase_nfgcell = [PreferPhase_nfgcell,Ua];
            title(TT0t64{cellid})
            subplot(2,1,2)
...
%             saveas(ffp,[outFolder 'NFG ' TT0t64{cellid} '-' num2str(D) '.png']);
%             saveas(ffp,[outFolder 'NFG ' TT0t64{cellid} '-' num2str(D) '.eps'],'epsc');
            for nl = 1:5
...
AA = sum(sum(cellnum_fg))
BB = sum(sum(cellnum_nonfg))
