        ...
        for nl = 1:5
            ...
            for D = 1:2
                ...
                file_input1 = strcat(path_ns,subfolder1,...
                    'scores',num2str(nseg),'-',num2str(nl),case1,'_TSlap_vel0',lockat{L},'v2.mat');
...
%                     saveas(figure(1),[outFolder, '1-CWphase_', case3, '_decoding_single_lap',num2str(nl),case1,lockat{L},'v2.png'])
                else
%                     plot_decodeingandtheta_CCW(scores,thetacycle,nl,TS_running,mth)
%                     saveas(figure(1),[outFolder, '2-CCWphase_', case3, '_decoding_single_lap',num2str(nl),case1,lockat{L},'v2.png'])
                end
                clf
                %%
...
%             plot_NPX(NPX2(28:63,:),mid_tbins,cycind,abc)
            ...
            %%
%             save([outFolder,'data_theta_seq_info',case1,'_lap',num2str(nl),case2,case3,midmod,lockat{L},'_v5-bothv2.mat'],...
...
%         saveas(figure(2),[outFolder,'thetaseq_strcture',case1,'1',case2,case3,midmod,lockat{L},'-bothv2.png']);clf
%         saveas(figure(3),[outFolder,'thetaseq_strcture',case1,'2',case2,case3,midmod,lockat{L},'-bothv2.png']);clf
%         
%         saveas(figure(4),[outFolder,'thetaseq_pxn',case1,'1',case2,case3,midmod,lockat{L},'-bothv2.png']);clf
%         saveas(figure(5),[outFolder,'thetaseq_pxn',case1,'2',case2,case3,midmod,lockat{L},'-bothv2.png']);clf
%         
%         save([outFolder,'data_theta_seq_info','_AllLap',case1,case2,case3,midmod,lockat{L},'_v5-bothv2.mat'],...
%             'theta_INFO','alignpxn')
    end
end
