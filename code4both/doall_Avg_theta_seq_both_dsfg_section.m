% crate by WN on 2022/07/19
% 找到好的相位后使用
% 用原始条件的窗口截取排除非fastgamma相锁神经元解码出来的TTS
        ...
        for nl = 1:5
            ...
            for S = 1:3
                for D = 1:2
                    ...
                    file_input6 = [outFolder,'data_theta_seq_info-ontrack',...
                        '_lap',num2str(nl),case2,case3,midmod,'_v5-both-',num2str(S), '_v2.mat'];
                    if ~exist(file_input6,'file')
                        disp([ Directionfolder{D},lockat{L},': lap' num2str(nl) 'have no enough sequence'])
                        continue
                    end
                    load(file_input6,'thetaind')
                    ...
                    if D == 1
                        ...
                        %                         saveas(figure(1),[outFolder, '1-CWphase_', case3, '_decoding_single_lap',num2str(nl),case1,lockat{L},'.png'])
                    else
                        figure(D)
                        plot_decodeingandtheta_CCW(scores,thetacycle,nl,TS_sec,mth)
                        %                         saveas(figure(1),[outFolder, '2-CCWphase_', case3, '_decoding_single_lap',num2str(nl),case1,lockat{L},'.png'])
                    end
                    clf
                    %%
                    ...
                    spikes = spikes(ind,:);
                    % find cell on track and exclude non fgamma phase locking cell
                ...
                %% 保存每一圈的的sequence
                save([outFolder,...
                    'data_theta_seq_info',case1,'_lap',num2str(nl),case2,case3,midmod,lockat{L},'_v5-both-',num2str(S), '_v2.mat'],...
                    'ThetaGood','mid_cycle','midcy_pxn',...
                    'mid_tbins','cycind','abc',...
                    'TSS','TSS_mean1','TSS_mean2','iii')
            end
        end
        saveas(figure(3),[outFolder,'thetaseq_strcture',case1,'1',case2,case3,midmod,lockat{L},'-part_v2.png']);clf
        saveas(figure(4),[outFolder,'thetaseq_strcture',case1,'2',case2,case3,midmod,lockat{L},'-part_v2.png']);clf
        
        saveas(figure(5),[outFolder,'thetaseq_pxn',case1,'1',case2,case3,midmod,lockat{L},'-part_v2.png']);clf
        saveas(figure(6),[outFolder,'thetaseq_pxn',case1,'2',case2,case3,midmod,lockat{L},'-part.png']);clf
        
        %         saveas(ff,[outFolder,'speed_over_lap',case1,case2,case3,midmod,lockat{L},'-part.png']);
        save([outFolder,'data_theta_seq_info','_AllLap',case1,case2,case3,midmod,lockat{L},'_v5-part_v2.mat'],...
            'theta_INFO','alignpxn')
    end
end
