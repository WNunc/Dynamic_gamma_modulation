...
%         save([outFolder 'Probability Difference' ncases Qsize case3 midmod lockat{L} '.mat'],'PD1','PD2')
    end
    ...
    set(gca,'FontSize',18)
    legend({'allcell','exfgcell','exnonfgcell'},'Position',[0.85,0.75,0.13,0.20])
%     saveas(ff2,['H:\neuralynx\gamma in sequence result\Probability Difference_' lockat{L} '_both.png'])
%     save(['H:\neuralynx\gamma in sequence result\Probability Difference_' lockat{L} '_both.mat'],...
%         'PD1_all','PD2_all')
end
