...
%             end
            ...
            file_input3 = strcat(path_ns,subfolder,'Cells_allsegment_v1_vel_0.mat');% load spike
            S1 = load(file_input3);
            
            file_input4 = strcat(path_ns,subfolder,'Cells_allsegment_v1_vel_5.mat');% load rate map
            S2 = load(file_input4);
            ...
            fprintf(txtid,'input file:\n%s\n%s\n%s\n%s\n%s\ntheta windows file:\n%s\n',...
                file_input1,file_input2,file_input3,file_input3,file_input5,file_input6);
            lap_ts = scores{nl,6};
            lap_pxn = scores{nl,3};
            lap_bin = scores{nl,4};
